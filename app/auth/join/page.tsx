...
export default function JoinPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mock success - redirect to onboarding
        ...
        >
          <div className="glass rounded-2xl p-8">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">{t('joinHexora')}</h1>
              <p className="text-white/60">{t('joinSubtitle')}</p>
            </div>
              ...
              <div>
                <label className="flex items-start">
                  <input
                    ...
                    className="w-4 h-4 text-primary bg-white/5 border-white/10 rounded focus:ring-primary focus:ring-2 mt-1"
                  />
